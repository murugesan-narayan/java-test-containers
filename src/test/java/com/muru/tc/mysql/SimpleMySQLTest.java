...
import com.muru.tc.db.AbstractContainerDatabaseTest;
    ...
    */
    ...
    public void testSimple() throws SQLException {
        MySQLContainer mysql = (MySQLContainer) new MySQLContainer()
                //.withConfigurationOverride("mysql_conf/my.cnf")
    ...
    public void testMySQLWithCustomIniFile() throws SQLException {
        ...
        try {
            ...
            assertEquals("The InnoDB file format has been set by the ini file content", "Antelope", result);
        } finally {
    ...
    public void testExplicitInitScript() throws SQLException {
        try (MySQLContainer container = (MySQLContainer) new MySQLContainer()
                .withInitScript("mysql_conf/init_mysql.sql")
                .withLogConsumer(new Slf4jLogConsumer(logger))) {
            container.start();
